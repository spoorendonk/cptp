...
/// Jepsen et al. (2014) found 0.4 optimal with CPLEX's built-in cuts.
...
struct SeparationContext {
  ...
  /// All-pairs shortest path bounds: flat n×n matrix, d(s,v) =
  /// all_pairs[s*n+v]. Empty when not available. Used by SPISeparator.
