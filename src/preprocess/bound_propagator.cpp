...
std::vector<int32_t> BoundPropagator::propagate_fixed_edge(
    ...
    if (!all_pairs_.empty()) {
        ...
        for (int32_t ej = 0; ej < m; ++ej) {
            ...
            double lb1 = d_depot_a + cost_ai + all_pairs_[i * n + u] + edge_costs_[ej] + all_pairs_[v * n + depot] + correction_;
            double lb2 = all_pairs_[depot * n + u] + edge_costs_[ej] + all_pairs_[v * n + a] + cost_ai + d_i_depot + correction_;
            double lb3 = d_depot_a + cost_ai + all_pairs_[i * n + v] + edge_costs_[ej] + all_pairs_[u * n + depot] + correction_;
            double lb4 = all_pairs_[depot * n + v] + edge_costs_[ej] + all_pairs_[u * n + a] + cost_ai + d_i_depot + correction_;
            double lb5 = d_depot_i + cost_ai + all_pairs_[a * n + u] + edge_costs_[ej] + all_pairs_[v * n + depot] + correction_;
            double lb6 = all_pairs_[depot * n + u] + edge_costs_[ej] + all_pairs_[v * n + i] + cost_ai + d_a_depot + correction_;
            double lb7 = d_depot_i + cost_ai + all_pairs_[a * n + v] + edge_costs_[ej] + all_pairs_[u * n + depot] + correction_;
            double lb8 = all_pairs_[depot * n + v] + edge_costs_[ej] + all_pairs_[u * n + i] + cost_ai + d_a_depot + correction_;
