...
void print_result(const std::string& instance_name, const Problem& prob,
  ...
  switch (result.status) {
    case SolveResult::Status::Optimal:
      status_str = "OPTIMAL";
      break;
    case SolveResult::Status::Feasible:
      status_str = "FEASIBLE";
      break;
    case SolveResult::Status::TimeLimit:
      status_str = "TIME_LIMIT";
      break;
    case SolveResult::Status::Infeasible:
      status_str = "INFEASIBLE";
      break;
    case SolveResult::Status::Unbounded:
  ...
  std::cout << "  Objective: " << result.objective
            << "  Bound: " << result.bound << "  Gap: " << (result.gap * 100.0)
            << "%\n";
